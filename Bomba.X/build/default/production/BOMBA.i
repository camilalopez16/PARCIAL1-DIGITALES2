...
resetVec:
    ...
    BSF TRISC,2 ; SENSOR1 DE CONCENTRACCION DE PORTD,4

    ;------------------------------------------


    BCF TRISD,0 ; PORTD,0 DE AGUA
    BCF TRISD,1 ; LED AMARILLO
    BCF TRISD,2 ; TEMPERATURA
    BCF TRISD,3 ; LED ROJO
    BCF TRISD,4 ; CONCENTRACCION DE PORTD,4
    ...
    NIVEL_A:
    BTFSC PORTB,0 ; SESOR NIVEL >= REFERENCIA DE AGUA
    CALL BOMBA_LLENA
    GOTO TEMPERATURA

    TEMPERATURA:
    BTFSC PORTB,1 ; SENSOR DE TEMPERATURA >= REFERENCIA
    CALL CALEFACCION
    GOTO OXIG

    OXIG:
    BTFSC PORTB,2 ; SENSOR1 DE CONCENTRACCION DE PORTD,4
    GOTO main
